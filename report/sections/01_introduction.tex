...
Sections~\ref{sec:fnn} and~\ref{sec:rnn} introduce the feedforward and recurrent
neural network architectures respectively.
Section~\ref{sec:conclusion} closes the report with a cross-model comparison and
a discussion of limitations and future directions.
