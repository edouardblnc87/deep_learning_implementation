...
\begin{figure}[H]
  \centering
  % Export figure from notebook cell 9 as figures/fig05_linreg_pred.png
  \fcolorbox{gray!60}{gray!10}{\parbox{0.85\textwidth}{\centering\vspace{1.5cm}
    \textcolor{gray}{\textbf{[Figure placeholder]}\\
    Linear regression predictions (orange) vs actual realized volatility (blue).
    The model predicts near-zero at all times; largest residuals occur during crises.}\vspace{1.5cm}}}
...
The GARCH(1,1) model \citep{bollerslev1986generalized} provides a parametric volatility
